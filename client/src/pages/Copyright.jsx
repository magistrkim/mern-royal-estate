      ...
      <div className="max-container padding-x">
        <div className="flex flex-col gap-2 sm:gap-4 pt-2 max-w-full sm:max-w-[680px]">
          ...
          <ul className="flex flex-col gap-2">
            ...
            <li>
              <p className="text-slate-600 text-sm sm:text-base font-roboto">
                <strong>Application</strong> refers to RoyalEstate, the software
            ...
            <li>
              <p className="text-slate-600 text-sm sm:text-base font-roboto">
                ...
                in this Agreement) refers to RoyalEstate.
              </p>
            </li>
            <li>
              <p className="text-slate-600 text-sm sm:text-base font-roboto">
          ...
          <h2 className="text-secondary font-bold font-poppins uppercase text-2xl mt-4">
          ...
          <p className="text-slate-600 text-sm sm:text-base font-roboto">
            By mail: 767 Fifth Avenue New York, NY 10153, United States
          </p>
        </div>
      </div>
    </section>
